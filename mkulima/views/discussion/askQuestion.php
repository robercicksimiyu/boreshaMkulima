...
<h3></h3>
<?php echo form_open('discussion/askQuestion');?>
	<input placeholder="Type your question here" type="search" name="ask_question" id="search">
	<button style="margin:auto;">Ask question</button>
</form>
<div>
