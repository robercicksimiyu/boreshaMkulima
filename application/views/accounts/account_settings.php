...
<div role="main" class="page page--primary category-javascript">
    <button href="/boreshaMkulima/discussion/askQuestion">Disable Account</button>
    <h2 class="page_banner_title"><a href="#"><?php echo $profile_data[0];?></a></h2>
    <hr></hr>
