          ...
          <div class="item active">
            ...
            <div class="container">
              <div class="carousel-caption">
                ...
                <p><a class="btn btn-large btn-primary" href="<?php echo base_url('accounts/create_account');?>" class="category-ux menuitem">Sign up today</a></p>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form class="" action="/boreshaMkulima/accounts/login" method="post">
          <?php 
          if(isset($message)){
