      ...
      <li id="post-1234898982 highlighted-post " class="post ">
          <div data-role="post-content" class="post-content main_question">
           ...
           <div class="post-body">
              ...
              <ul class="post-menu dropdown" data-role="menu">
                <li class="collapse"><a href="#" data-action="collapse" title="Collapse"><span>−</span></a>
                </li>
              ...
              <menu>
                ...
                <li class="voting" data-role="voting">
                    <a href="#" class="vote-up  count-16" data-action="upvote" title="">
                      ...
                      <span class="control"><i aria-hidden="true" class="icon icon-arrow-2"></i></span></a>
                    ...
                    <a class="vote-down  count-0" title="Vote down">
                      ...
                      <span class="tooltip">You must sign in to down-vote this post.</span></a>
                </li>
                <li class="bullet" aria-hidden="true"><i class="glyphicon glyphicon-share-alt"></i></li>

                <li class="reply"><a data-action="reply" data-toggle="modal" href="#<?php echo $question->id;?>" class="">Reply</a></li>
                <li class="bullet" aria-hidden="true">•</li>
                <li class="share"><a class="toggle"><i class="icon icon-mobile icon-share"></i><span class="text">Share ›</span></a>
                  <ul>
        ...
        <?php if($this->discussion_answer($question->id)) 
          ...
          <div data-role="post-content" class="post-content question_answer">
            ...
            <div class="post-body">
            <header>
                <span class="post-byline"><span class="author publisher-anchor-color"><a href="<?php echo base_url('accounts/profile/'.$question->username);?>" data-action="profile" data-user="26794029" data-role="username"><?=$answer->username?></a></span>
          ...
          <menu>
            <li class="realtime" data-role="realtime-notification:1234932123">
              <span style="display:none;" class="realtime-replies"></span>
                <a style="display:none;" href="#" class="btn btn-small"></a></li>
           ...
           <li class="reply">
            <a data-action="reply" data-toggle="modal" href="#<?php echo $answer->id;?>" class="">Comment</a>
           </li>

            <li class="bullet" aria-hidden="true">•</li>
            <li class="share"><a class="toggle"><i class="icon icon-mobile icon-share"></i>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Answer Comment</h4>
      </div>
...
<div class="modal fade" id="<?php echo $question->id;?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
        <h4 class="modal-title">Question Reply</h4>
      </div>
      <div class="modal-body">
       
       	
       		<textarea  name="main_post_comment"></textarea>
